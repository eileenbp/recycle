        ...
        <div class="slider">
            ...
            <div class="slide slide-1 active">
                ...
                <div class="text-baner">
                    ...
                    <p>قطره قطره سبز گردد...</p>

                </div>

                <div class="img-baner">

                    <img src="./imgs/slide-1.png" alt="">
            ...
            <div class="slide slide-1">
                <div class="text-baner">
                    ...
                    <p>از مزایده‌ها باخبر شو!</p>

                </div>

                <div class="img-baner">

                    <img src="./imgs/slide-3.png" alt="">
                </div>
    ...
    <!-- owl-title -->
     ...
     <div class="wrapper">
        ...
        <div class="carousel owl-carousel">
            ...
            <?php
                 $result = mysqli_query($con, " SELECT auction_id,title , a_image, DATEDIFF(end_date, CURRENT_DATE) AS 'Result' from auction where end_date BETWEEN CURRENT_DATE AND DATE_ADD(CURRENT_DATE,INTERVAL 7 DAY)  LIMIT 6");
                 $i=1;
                 while($row = mysqli_fetch_array($result)){
                ?>   
                    <div class="card card-<?php echo $i ?>">     
                        <img src="./imgs/upload/<?php echo $row['a_image'] ?>" alt="" >
                        
                        <p class=" title"><?php echo $row['title'] ?></p>
                        <?php 
                            if ($row['Result'] == '0')
                             {
                                ?> <p class=" title"> !فقط تا آخر امشب</p>
                            <?php    
                            }
                            else {?>
                        
                            <p class=" title">!تنها <?php echo $row['Result'] ?> روز باقی مانده</p>
                            <?php } ?>
                            
                        <a style="font-family:'YekanBakhMedium'; color:black;" href= <?php if(isset($_SESSION['user-login'])) {
                                                                                echo "./bid.php?auction_id=$row[auction_id]";}
                                        else {echo "./login/login.php";} ?> > <h6>شرکت در مزایده</h6> </a>

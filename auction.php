...
<body>
    ...
    <div style="font-family:YekanBakhMedium ;" class='div_user'>

            <label for='resdiue'>نوع ضایعات:</label>

            <select id='resdiue' name='resdiue' ><?php
            $result1 = mysqli_query($con, "SELECT * FROM residue ");
            ...
            <input style="font-family:YekanBakhMedium ; margin-right: 10px; padding: 5px; ;" id="btn_search" type="submit" name="search"  value="فیلتر">
  ...
  <br>
        ...
        if(isset($_SESSION['user-login']))
        {
                ...
                $userid=$x['user_id'];
                $result = mysqli_query($con, "SELECT auction_id, title , end_date FROM  auction WHERE end_date > CURRENT_DATE and user_id<>'$userid'  and status='1'");
        }
        else{
            $result = mysqli_query($con, "SELECT auction_id, title , end_date FROM  auction WHERE end_date > CURRENT_DATE  and status='1'");


        }
        if(isset($_POST['search'])){
            $res_id=$_POST['resdiue'];
            $result = mysqli_query($con, "SELECT auction_id, title , end_date FROM  auction WHERE end_date > CURRENT_DATE  and status='1' and residue_id='$res_id'");
            if(isset($_SESSION['user-login']))
            {
                    $username=$_SESSION['user-login'];
                    $result = mysqli_query($con, "SELECT * FROM  user WHERE username='$username'");
                    $x = mysqli_fetch_array($result);
                    $userid=$x['user_id'];
                    $result = mysqli_query($con, "SELECT auction_id, title , end_date FROM  auction WHERE end_date > CURRENT_DATE and user_id<>'$userid'  and status='1' and residue_id='$res_id'");
            }?>
            <form method="post">
            <input style="font-family:YekanBakhMedium ; margin-right: 10px; padding: 5px;" id="btn_search" type="submit" name="showall"  value="نمایش همه" >
            ...
            <div class="row ">
                ...
                <div class="column">
                    <div class="card"> 
                        ...
                        <p style="font-family:'iranyekanwebregular'"><?php echo $row['end_date'];?></p>
                </br>
                <?php ?>

                        <a style="font-family:'YekanBakhMedium'" href= <?php if(isset($_SESSION['user-login'])) {
                                                                                echo "./bid.php?auction_id=$row[auction_id]";}
                                        else {echo "./login/login.php";} ?> > <small>شرکت در مزایده</small> </a>
                    </div>
                </div>
                <?php }?>

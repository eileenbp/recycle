<?php
    ...
    $userid=$x['user_id'];
    $result4 = mysqli_query($con, "SELECT bid.bid_id,bid.price,bid.status, auction.auction_id,bid.description,bid.weigth_unit,auction.title, auction.weigth as auc_weight  ,bid.weigth as bid_weight from bid INNER JOIN auction  on bid.auction_id=auction.auction_id WHERE bid.user_id=$userid");
    ...
    if(isset($_POST['submit']))
    {
        ...
        $bid_edit=$_POST['bid_id'];
      

        
          $edit =  mysqli_query($con, "UPDATE bid SEt weigth='$weight' , price='$priceedit' , description='$descriptionedit' 
          where bid_id= '$bid_edit' ");
        ...
        header("Refresh:0");
         ...
         if(isset($_POST['submit2']))
         {
             ...
             $bid_delete=$_POST['bid_id2'];
             echo $_POST['bid_id2'];
           
     
             
               $edit =  mysqli_query($con, "DELETE FROM bid WHERE bid_id= '$bid_delete' ");
...
<body>
      ...
      <div class="main-div">
          <div class=main-info>
            ...
            <table>
                                ...
                                <tr>
                                    <td><?php echo $i++ ?></td>
                                    <td> <a class="txthover" <?php echo "href='./auctionShow.php?auction_id=$bid[auction_id]'"?>><?php echo $bid['auction_id'] ?></a></td>
                                    <td> <?php echo $bid['bid_weight'] ?></td>
                                    <td> <?php 
                                    ...
                                    <p style="display:none;" class='weight_auc'><?php echo $bid['auc_weight'] ?></p>
                                    ...
                                    <div class="main-modal">
                                        ...
                                        <form method='post' class='mybid-edit-form' name='mybid-edit-form' enctype='multipart/form-data'>

                                                    <div style="display: none;" class='div_user'>
                                                        <p class='text_user'> وزن: </p>
                                                        
                                                                <input class='input_user' name='bid_id'  placeholder='وزن تقریبی' type='text' value=<?php echo $bid['bid_id']; ?>>
                                                    ...
                                                    <div class='div_user'>
                                                        <p class='text_user'> وزن: </p>
                                                                ...
                                                                <input class='input_user w1' name='w' id='w1' placeholder='وزن تقریبی' type='text' value=<?php echo $bid['bid_weight']; ?>>
                                                    ...
                                                    <div class='div_user'>
                                                        ...
                                                        <label for='weight'>واحد:<?php echo '  '.$bweigth_unit;?></label>
                                                ...
                                                <div class='div_user'>
                                                    ...
                                                    <input class='input_user' name='price' id='cnum2'  placeholder=' قیمت' type='text' value= <?php echo $bid['price']; ?>>
                                                    ...
                                                    <div class='div_user'>
                                                          ...
                                                          <textarea name='description' rows='5' cols='33' value=<?php echo $bid['description'];  ?>></textarea>

                                                          
                                                    </div>
                                                      <input id='btn_user_auth2' onsubmit="validate()" type='submit' name='submit'  value='ویرایش'>
                                    ...
                                    <div class="main-modal2">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <span class="edit-info"> حذف پیشنهاد</span>
                                            </div>
                                        <div class="modal-body">
                                            <form method='post' name='biddelete-form'>
                                                <p>آیا از حذف پیشنهاد خود اطمینان دارید؟</p>
                                                <div style="display: none;" class='div_user'>
                                                        <p class='text_user'> وزن: </p>
                                                        
                                                                <input class='input_user' name='bid_id2' id='w1' placeholder='وزن تقریبی' type='text' value=<?php echo $bid['bid_id']; ?>>
    ...
    <script src="./js/editmybid.js"></script>

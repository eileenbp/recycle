<?php
    ...
    ///adver
    $adverresult = mysqli_query($con, "SELECT * FROM  adver WHERE user_id='$userid'");
    
    //auction
    $auctionresult = mysqli_query($con, "SELECT * FROM  auction WHERE user_id='$userid'");

    //personal-auth
    $personal_authresult = mysqli_query($con, "SELECT * FROM  personal_auth WHERE user_id='$userid'");

    //job-auth
    $job_authresult = mysqli_query($con, "SELECT * FROM  job_auth WHERE user_id='$userid'");
...
<body>
    ...
    <div  class="main-info feedback" >
                <div class="row">
                <p>  آگهی خرید و فروش :</p>  
                <br>
                                    <?php
                                    
                                    
                                        while($adver_row = mysqli_fetch_array($adverresult)) {
                                            echo "<div class='column'>";
                                            echo "<div class='card'>";
                                            echo "<span>آگهی خرید/ فروش شما به کد".'  '."</span>";
                                            echo "<span><a  class='txthover' href='../more.php?adver_id=$adver_row[adver_id]'>".$adver_row['adver_id'].'  '."</a></span>";
                                            if($adver_row['status']=='-1'){ echo "<span style='color:red'>رد شد.</span>";}
                                            elseif($adver_row['status']=='1'){echo "<span style='color:green'>منتشر شد.</span>";}
        ...
        <div  class="main-info feedback" >
                ...
                <br>
                                    <?php
                                        ...
                                        while($auction_row = mysqli_fetch_array($auctionresult)) {
                                            echo "<div class='column'>";
                                            echo "<div class='card'>";
                                            echo "<span>آگهی مزایده شما به کد".'  '."</span>";
                                            echo "<span><a class='txthover' href='../auctionShow.php?auction_id=$auction_row[auction_id]'>".$auction_row['auction_id'].'  '."</a></span>";
                                            if($auction_row['status']=='-1'){ echo "<span style='color:red'>رد شد.</span>";}
                                            elseif($auction_row['status']=='1'){echo "<span style='color:green'>منتشر شد.</span>";}
        ...
        <div  class="main-info auth" >
                ...
                <br>
                                    <?php
                                        ...
                                        while($perauth_row = mysqli_fetch_array($personal_authresult)) {
                                            echo "<div class='column'>";
                                            echo "<div class='card'>";
                                            echo "<span>احراز هویت شخصی شما".'  '."</span>";
                                            if($perauth_row['status']=='-1'){ echo "<span style='color:red'>رد شد.</span>";}
                                            elseif($perauth_row['status']=='1'){echo "<span style='color:green'>تایید شد.</span>";}
                                    ...
                                    while($jobauth_row = mysqli_fetch_array($job_authresult)) {
                                        echo "<div class='column'>";
                                        echo "<div class='card'>";
                                        echo "<span>احراز هویت شغلی شما".'  '."</span>";
                                        if($jobauth_row['status']=='-1'){ echo "<span style='color:red'>رد شد.</span>";}
                                        elseif($jobauth_row['status']=='1'){echo "<span style='color:green'>تایید شد.</span>";}

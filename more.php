<?php
    ...
    $result2 = mysqli_query($con, "SELECT * FROM adver WHERE adver_id=$adver_id");
...
<body>
    ...
    <div class="main-div">
        <div class=main-info>
        <span class="right-span"><img class="imagee" src="./imgs/upload/<?php echo $y['image'] ?>" alt="" ></span>
        <?php 
        $userid=$y['user_id'];
        $resultx = mysqli_query($con, "SELECT username FROM  user WHERE user_id=$userid");
        $username = mysqli_fetch_array($resultx);?>
        <span><a class="txthover" href=<?php echo"./feedbacksubmit.php?userid=$userid" ?> ><h5>آگهی دهنده:<?php echo '  '.$username['username'] ?></h5></a></span>
        <span><h5>عنوان آگهی:<?php echo '  '.$y['title'] ?></h5></span>
        <?php 
        if($y['weigth_unit']=='0')
            $weigth_unit='تن';
        ...
        <span><h5>قیمت :<?php echo '  '.$y['price'].'  '.'تومان';?></h5></span>

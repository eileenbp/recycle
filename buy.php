...
<body>
  ...
  <br>
        ...
        if(isset($_SESSION['user-login']))
        {
                ...
                $userid=$x['user_id'];
                $result = mysqli_query($con, "SELECT adver_id ,title , price FROM  adver WHERE user_id<>'$userid'  and status='1' and advertype='1'");
        }
        else{
            $result = mysqli_query($con, "SELECT adver_id ,title , price FROM  adver WHERE  status='1' and advertype='1'");


        }
        if(isset($_POST['search'])){
            $res_id=$_POST['resdiue'];
            $result = mysqli_query($con, "SELECT adver_id ,title , price FROM  adver WHERE status='1' and advertype='1' and residue_id='$res_id'");
            if(isset($_SESSION['user-login']))
            {
                    $username=$_SESSION['user-login'];
                    $result = mysqli_query($con, "SELECT * FROM  user WHERE username='$username'");
                    $x = mysqli_fetch_array($result);
                    $userid=$x['user_id'];
                    $result = mysqli_query($con, "SELECT adver_id ,title , price FROM  adver WHERE user_id<>'$userid'  and status='1' and advertype='1' and residue_id='$res_id'");
            }?>
            <form method="post">
        ...
        if(isset($_POST['showall'])){
            $result = mysqli_query($con, "SELECT adver_id ,title , price FROM  auction WHERE  status='1'");
            if(isset($_SESSION['user-login']))
            {
                    $username=$_SESSION['user-login'];
                    $result = mysqli_query($con, "SELECT * FROM  user WHERE username='$username'");
            ...
            <div class="row ">
                ...
                <div class="column">
                    <div class="card"> 
                        ...
                        <p style="font-family:'iranyekanwebregular'"><?php echo $row['price'];?></p>
                </br>
                <?php ?>

                        <a style="font-family:'YekanBakhMedium'" href= <?php if(isset($_SESSION['user-login'])) {
                                                                                echo "./more.php?adver_id=$row[adver_id]";}
                                        else {echo "./login/login.php";} ?> > <small> بیشتر </small> </a>
                    </div>
                </div>
                <?php }?>
